...
import pistachioOne from './images/pistacchio2.jpg';
import './content.css'
...
const Pistachio_ice = () => {
  return (
    ...
    <img className='image' src={pistachioOne} alt='pista'/>
...
<div className="list1">
<ul>
  <li>2 cups shelled roasted pistachios, divided</li>
  ...
  <li>Green food coloring, optionalk</li>
  </ul>
</div>
...
In a food processor, combine 1 cup of pistachios with ¼ cup of granulated sugar. Process until finely ground.
